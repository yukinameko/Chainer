...
class OctConv2dOut(OctConv2dBase):
	...
	def __init__(self, in_channels, out_channels, in_alpha=0 ksize=None, stride=1, pad=0, nobias=False, initialW=None, initial_bias=None, *, dilate=1, groups=1):
		super(OctConv2dIn, self).__init__(in_channels, out_channels, in_alpha=in_alpha, out_alpha=0, ksize=ksize, stride=stride, pad=pad, nobias=nobias, initialW=initialW, initial_bias=initial_bias, dilate=dilate, groups=groups)
